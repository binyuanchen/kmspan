...
public class KmspanConfiguration {
    ...
    @UriParam(defaultValue = KmspanConstants.KAFKA_DEFAULT_PARTITIONER)
    private String partitioner = KmspanConstants.KAFKA_DEFAULT_PARTITIONER;
    ...
    //kmspan zookeepers for event coordination
    @UriParam(label = "consumer", defaultValue = SpanConstants.DEFAULT_SPAN_ZK_QUORUM)
    private String spanCoordZkServers = SpanConstants.DEFAULT_SPAN_ZK_QUORUM;
    @UriParam(label = "consumer", defaultValue = SpanConstants.DEFAULT_SPAN_ZK_QUORUM)
    private String spanSCBeginZPath = SpanConstants.DEFAULT_SPAN_BEGIN_SC_ZPATH;
    @UriParam(label = "consumer", defaultValue = SpanConstants.DEFAULT_SPAN_END_SC_ZPATH)
    private String spanSCEndZPath = SpanConstants.DEFAULT_SPAN_END_SC_ZPATH;
    @UriParam(label = "consumer")
    private String spanEventListener;

    //key.deserializer
    @UriParam(label = "consumer", defaultValue = KmspanConstants.KAFKA_DEFAULT_DESERIALIZER)
    private String keyDeserializer = KmspanConstants.KAFKA_DEFAULT_DESERIALIZER;
    //value.deserializer
    @UriParam(label = "consumer", defaultValue = KmspanConstants.KAFKA_DEFAULT_DESERIALIZER)
    private String valueDeserializer = KmspanConstants.KAFKA_DEFAULT_DESERIALIZER;
    //fetch.min.bytes
    ...
    @UriParam(label = "consumer", defaultValue = KmspanConstants.PARTITIONER_RANGE_ASSIGNOR)
    private String partitionAssignor = KmspanConstants.PARTITIONER_RANGE_ASSIGNOR;
    //request.timeout.ms
    ...
    public Properties createConsumerProperties() {
        ...
        addPropertyIfNotNull(props, SslConfigs.SSL_TRUSTMANAGER_ALGORITHM_CONFIG, getSslTrustmanagerAlgorithm());
        // Kmspan
        addPropertyIfNotNull(props, SpanConstants.SPAN_ZK_QUORUM, getSpanCoordZkServers());
        addPropertyIfNotNull(props, SpanConstants.SPAN_BEGIN_SC_ZPATH, getSpanSCBeginZPath());
        addPropertyIfNotNull(props, SpanConstants.SPAN_END_SC_ZPATH, getSpanSCEndZPath());
        return props;
    }
    ...
    public String getSpanCoordZkServers() {
        return spanCoordZkServers;
    }

    public void setSpanCoordZkServers(String spanCoordZkServers) {
        this.spanCoordZkServers = spanCoordZkServers;
    }
    ...
    public String getSpanEventListener() {
        return spanEventListener;
    }

    public void setSpanEventListener(String spanEventListener) {
    ...
    public String getSerializerClass() {
        if (serializerClass == null) {
            return KmspanConstants.KAFKA_DEFAULT_SERIALIZER;
        }
    ...
    /**
     * The timeout used when polling the KmspanConsumer.
     */
    ...
    /**
     * If the option is true, then KmspanConsumer will read from beginning on startup.
     */
     ...
     * the message that was sent to it from {@link KmspanProducer} using asynchronous non-blocking processing.
     */
     ...
     * The list is stored on a header with the key {@link KmspanConstants#KAFKA_RECORDMETA}
     */
